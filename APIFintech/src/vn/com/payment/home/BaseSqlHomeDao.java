...
//	public boolean saveTransaction111111111(Object obj1, Object obj2, List<TblImages> obj3, List<TblLoanBill> obj4, TblLoanRequestAskAns obj5) throws Exception {
//		Session session = null;
...
//	}
	...
	public boolean saveOrUpdateTransIMG(Object obj1, List<TblImages> obj2) throws Exception {
		Session session = null;
		boolean result = false;
		try {
			session = HibernateUtil.getSessionFactory().openSession();
...
//		BaseSqlHomeDao baseSqlHomeDao = new BaseSqlHomeDao();
//		try {
//			String aa = baseSqlHomeDao.a();
