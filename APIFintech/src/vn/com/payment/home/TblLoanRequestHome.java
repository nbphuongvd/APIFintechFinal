...
public class TblLoanRequestHome extends BaseSqlHomeDao{
	...
	public boolean createLoanTransIMG(TblLoanRequest tblLoanRequest, List<TblImages> imagesList) {
		try {
			boolean checkSaveTrans = saveOrUpdateTransIMG(tblLoanRequest, imagesList);
			System.out.println("id: " + tblLoanRequest.getLoanId());
			return checkSaveTrans;
		} catch (Exception e) {
			e.printStackTrace();
