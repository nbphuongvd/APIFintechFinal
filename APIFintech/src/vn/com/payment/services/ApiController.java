...
public class ApiController {
   ...
   @Produces({MediaType.APPLICATION_JSON})
   public Response listDebtReminder(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong setAllotment");
	   Bussiness bussiness = new Bussiness();
   	   System.out.println(formParams);
	   return bussiness.listDebtReminder(formParams);
   }
 ...
 //List inbox
   @POST
   @Path("/api/getListInbox")
   @Produces({MediaType.APPLICATION_JSON})
   public Response getListInbox(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong getListInbox");
	   Bussiness bussiness = new Bussiness();
   	   System.out.println(formParams);
	   return bussiness.getListInbox(formParams);
   }
   
 //List inbox
   @POST
   @Path("/api/updateInbox")
   @Produces({MediaType.APPLICATION_JSON})
   public Response updateInbox(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong getListInbox");
	   Bussiness bussiness = new Bussiness();
   	   System.out.println(formParams);
	   return bussiness.updateInbox(formParams);
   }
   // Cap nhat bao hiem
   
   @POST
   @Path("/api/updateInsurance")
   @Produces({MediaType.APPLICATION_JSON})
   public Response updateInsurance(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong updateInsurance");
	   Bussiness bussiness = new Bussiness();
   	   System.out.println(formParams);
	   return bussiness.updateInsurance(formParams);
   }
   
   @POST
   @Path("/api/sentEmail")
   @Produces({MediaType.APPLICATION_JSON})
   public Response sentEmail(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong updateInsurance");
	   Bussiness bussiness = new Bussiness();
   	   System.out.println(formParams);
	   return bussiness.sentEmail(formParams);
   }
   
   @POST
   @Path("/api/getUserInfo")
   @Produces({MediaType.APPLICATION_JSON})
   public Response getUserInfo(@Context HttpServletRequest requestContext, @javax.ws.rs.core.Context HttpHeaders headers, String formParams) {
	   System.out.println("Vao xooong getUserInfo");
	   UserInfo userInfo = new UserInfo();
   	   System.out.println(formParams);
	   return userInfo.getUserInfo(formParams);
   }
