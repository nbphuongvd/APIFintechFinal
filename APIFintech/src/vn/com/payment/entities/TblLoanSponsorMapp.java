...
// Generated Jun 18, 2021 12:28:02 AM by Hibernate Tools 3.5.0.Final
 ...
 */
@Entity
@Table(name = "tbl_loan_sponsor_mapp")
public class TblLoanSponsorMapp implements java.io.Serializable {
	...
	public TblLoanSponsorMapp(int loanId, int sponsorId, Date createdDate, Date disbursementDate,
			Integer disbursementStatus, Date entryExpireTime, Integer insuranceProviderId) {
		this.loanId = loanId;
		this.sponsorId = sponsorId;
