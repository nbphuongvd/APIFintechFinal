...
public class ReqUDExtendStatus {
	...
	public String borrower_reply_remark;
	...
	public String getBorrower_reply_remark() {
		return borrower_reply_remark;
	}

	public void setBorrower_reply_remark(String borrower_reply_remark) {
		this.borrower_reply_remark = borrower_reply_remark;
	}
